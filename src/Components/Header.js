...
function Header() {
  ...
  return (
    <header className=" mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2">
        ...
        <div onClick={toggleClass} className="cursor-pointer">
          <svg
            className="stroke-dark-heading dark:stroke-dark-heading md:hidden"
            width="25"
            height="20"
            viewBox="0 0 16 13"
            fill="none"
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          ...
          <li>
            <a href={github} target="_blank" rel="noreferrer noopener">
              <svg
                className="dark:fill-black fill-dark-heading"
                width="30"
                height="30"
                viewBox="0 0 30 30"
                fill="none"
